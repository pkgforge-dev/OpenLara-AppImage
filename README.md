...
[![GitHub Downloads](https://img.shields.io/github/downloads/pkgforge-dev/OpenLara-AppImage/total?logo=github&label=GitHub%20Downloads)](https://github.com/pkgforge-dev/OpenLara-AppImage/releases/latest)
[![CI Build Status](https://github.com//pkgforge-dev/OpenLara-AppImage/actions/workflows/appimage.yml/badge.svg)](https://github.com/pkgforge-dev/OpenLara-AppImage/releases/latest)
...
| :---: | :---: |
| [Click here](https://github.com/pkgforge-dev/OpenLara-AppImage/releases/latest) | [Click here](https://github.com/XProger/OpenLara) |

</div>

## ⚠️ Game assets within `~/.openlara` ⚠️
